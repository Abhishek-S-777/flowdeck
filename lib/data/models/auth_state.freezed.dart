...
mixin _$AuthState {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, user, isAuthenticated, isLoading, error);
...
abstract mixin class $AuthStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {UserModel? user, bool isAuthenticated, bool isLoading, String? error});
...
extension AuthStatePatterns on AuthState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(UserModel? user, bool isAuthenticated, bool isLoading,
            String? error)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _AuthState() when $default != null:
        return $default(
            _that.user, _that.isAuthenticated, _that.isLoading, _that.error);
      case _:
        return orElse();
    }
  }
