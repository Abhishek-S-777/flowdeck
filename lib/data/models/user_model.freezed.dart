...
mixin _$UserModel {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other.boardIds, boardIds) &&
  ...
  int get hashCode => Object.hash(
      ...
      avatarUrl,
      isEmailVerified,
      const DeepCollectionEquality().hash(boardIds),
      createdAt,
      updatedAt);

  @override
  String toString() {
    return 'UserModel(id: $id, email: $email, firstName: $firstName, lastName: $lastName, avatarUrl: $avatarUrl, isEmailVerified: $isEmailVerified, boardIds: $boardIds, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
}
...
class _UserModel implements UserModel {
  const _UserModel(
      ...
      final List<String> boardIds = const [],
      this.createdAt,
      this.updatedAt})
      : _boardIds = boardIds;
